...
describe('Neo4jExporter', () => {
  ...
  describe('CSV Export', () => {
    ...
    it('should export graph with items to CSV', () => {
      // Add items
      graph.addItem({ id: 'REQ-001', role: 'requirement', title: 'Req 1', attributes: { priority: 'high' }, sourceFile: 'test.adoc' });
    ...
    it('should include all attributes in CSV export', () => {
      graph.addItem({
        ...
        role: 'requirement',
        title: 'Test Req',
        attributes: { priority: 'high', status: 'approved', author: 'test-user' },
  ...
  describe('Export Options', () => {
    ...
    it('should respect includeAllAttributes option', () => {
      ...
      const withoutAttrs = fs.readFileSync(resultWithout.nodesFile!, 'utf8');
  ...
  describe('Graph with Multiple Item Types', () => {
    it('should export graph with multiple roles', () => {
      ...
      graph.addItem({ id: 'IMP-001', role: 'implementation', title: 'Impl 1', attributes: {}, sourceFile: 'test.adoc' });
      graph.addItem({ id: 'TEST-001', role: 'test', title: 'Test 1', attributes: {}, sourceFile: 'test.adoc' });

      graph.addRelationship({ id: 'REL-001', fromId: 'DES-001', targetId: 'REQ-001', type: 'addresses', sourceFile: 'test.adoc' });
      graph.addRelationship({ id: 'REL-002', fromId: 'IMP-001', targetId: 'DES-001', type: 'implements', sourceFile: 'test.adoc' });
      graph.addRelationship({ id: 'REL-003', fromId: 'TEST-001', targetId: 'IMP-001', type: 'tests', sourceFile: 'test.adoc' });
  ...
  describe('Export Result', () => {
    it('should return correct counts in result', () => {
      ...
      graph.addItem({ id: 'REQ-003', role: 'requirement', title: 'Req 3', attributes: {}, sourceFile: 'test.adoc' });

      graph.addRelationship({ id: 'REL-001', fromId: 'REQ-001', targetId: 'REQ-002', type: 'depends', sourceFile: 'test.adoc' });
      graph.addRelationship({ id: 'REL-002', fromId: 'REQ-002', targetId: 'REQ-003', type: 'depends', sourceFile: 'test.adoc' });
