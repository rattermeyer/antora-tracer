...
This page maps concepts from https://sphinx-needs.readthedocs.io/[Sphinx Needs] to their equivalents in Antora Tracer. Sphinx Needs is a popular requirements traceability extension for the Sphinx documentation builder (Python). Antora Tracer provides similar functionality for Antora/AsciiDoc (Node.js).
...
| `traceability:links[]` macro with configurable style (list, table, inline)
