...
[#REQ-055, item, role=requirement, title="Zero operational overhead"]
--
...
[#REQ-056, item, role=requirement, title="Configurable without code changes"]
--
...
[#REQ-057, item, role=requirement, title="Fail-fast with clear diagnostics"]
--
...
[#REQ-058, item, role=requirement, title="No side effects on source files"]
--
...
[#REQ-059, item, role=requirement, title="Testability by design"]
--
