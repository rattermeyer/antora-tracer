...
====
*Single [item] macro replaces all block macros*
...
====
*[item] macro accepts role attribute*
...
[item, id=REQ-003, role=requirement]
====
*[item] macro maintains existing attributes*
...
[item, id=REQ-004, role=requirement]
====
*[item] macro supports block content*
...
[item, id=REQ-005, role=requirement]
====
*Old macro syntax generates deprecation error*
...
[item, id=REQ-006, role=requirement]
====
*Configuration defines roles*
...
[item, id=REQ-007, role=requirement]
====
*Configuration defines relations*
...
[item, id=REQ-008, role=requirement]
====
*Configuration defines matrices*
...
[item, id=REQ-009, role=requirement]
====
...
[item, id=REQ-010, role=requirement]
====
...
[item, id=REQ-011, role=requirement]
====
...
[item, id=REQ-012, role=requirement]
====
*Configuration can extend presets*
...
[item, id=REQ-013, role=requirement]
====
...
[item, id=REQ-014, role=requirement]
====
*Directional relation checking*
...
[item, id=REQ-015, role=requirement]
====
*Error messages list allowed relations*
...
[item, id=REQ-016, role=requirement]
====
*Warnings for unknown roles*
...
[item, id=REQ-017, role=requirement]
====
*Graceful degradation for unknown roles*
...
[item, id=REQ-018, role=requirement]
====
...
[item, id=REQ-019, role=requirement]
====
*Each preset contains complete configuration*
...
[item, id=REQ-020, role=requirement]
====
*Each preset includes documentation*
...
[item, id=REQ-021, role=requirement]
====
*Each preset includes Neo4j Cypher queries*
...
[item, id=REQ-022, role=requirement]
====
*Presets have independent versioning*
...
[item, id=REQ-023, role=requirement]
====
*Users can define custom presets*
...
[item, id=REQ-024, role=requirement]
====
*Neo4j CSV export*
...
[item, id=REQ-025, role=requirement]
====
*Neo4j Cypher export*
...
[item, id=REQ-026, role=requirement]
====
...
[item, id=REQ-027, role=requirement]
====
*Export includes all item attributes*
...
[item, id=REQ-028, role=requirement]
====
*Export is optional*
...
[item, id=REQ-029, role=requirement]
====
*Configurable matrix generation with coverage calculations*
...
[item, id=REQ-030, role=requirement]
====
...
[item, id=REQ-031, role=requirement]
====
*Graph path finding*
...
[item, id=REQ-032, role=requirement]
====
*Impact analysis*
...
[item, id=REQ-033, role=requirement]
====
*Graph merge*
...
[item, id=REQ-034, role=requirement]
====
...
[item, id=REQ-035, role=requirement]
====
*Antora extension integration*
...
[item, id=REQ-036, role=requirement]
====
*CLI commands*
