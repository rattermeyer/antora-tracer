...
The macro renders a Kroki-generated GraphViz DOT diagram showing the item and its direct relationships. Nodes are colored by role and edges are labeled with relation types.
