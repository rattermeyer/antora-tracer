...
--
The extension keeps two graphs: a working graph cleared per version for version-scoped xref generation (REQ-103), and an accumulated full graph merged after each version and read by the `sitePublished` generation passes.
