...
* Actionable: Clearly defines a task or outcome (for example "I want to reset my password").
* Problem-Oriented: Addresses a pain point or a job to be done.
* Non-Technical: Avoids implementation details (for example "The system should use OAuth 2.0" is not a user need).
pass:[<!-- vale on -->]
