...
The `adoc-to-docx` wrapper script in the project root connects the two steps. Each `antora-assembler-docx*.yml` config file mirrors its PDF counterpart but uses `./adoc-to-docx` as the build command.
