...
For the full lifecycle — re-pointing links, archiving, and removing — see xref:how-to/supersede-items.adoc[How to Supersede an Item].

== Display relationships in rendered output

Use the `tracer:outgoing[]` and `tracer:incoming[]` macros to show relationship lists:
