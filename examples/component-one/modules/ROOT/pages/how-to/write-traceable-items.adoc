...
This guide covers the practical workflow for writing traceable items. For the complete syntax specification, see xref:reference/item-macro.adoc[Item Macro Reference].
