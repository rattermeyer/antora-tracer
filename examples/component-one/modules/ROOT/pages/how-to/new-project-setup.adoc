...
At this stage the matrices will be empty because you haven't written any items yet. Continue to xref:how-to/write-traceable-items.adoc[How to write traceable items].
