...
2. Your `.adoc` files are in the Antora content catalog (have page family)
3. The files contain valid `[item]` blocks
...
Partials don't produce HTML pages — use inline relationship macros instead of +xref:partial$...+. See xref:how-to/partials.adoc[How to use partial files with items].
