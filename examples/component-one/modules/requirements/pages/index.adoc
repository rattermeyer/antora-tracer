...
xref:ROOT:quality/index.adoc[quality scenario pages], each with Context, Trigger,
and measurable Acceptance Criteria.

* xref:ROOT:quality/zero-operational-overhead.adoc#QA-055[QA-055 — Zero operational overhead]
* xref:ROOT:quality/configurable-without-code.adoc#QA-056[QA-056 — Configurable without code changes]
* xref:ROOT:quality/fail-fast-diagnostics.adoc#QA-057[QA-057 — Fail-fast with clear diagnostics]
* xref:ROOT:quality/no-side-effects.adoc#QA-058[QA-058 — No side effects on source files]
* xref:ROOT:quality/testability-by-design.adoc#QA-059[QA-059 — Testability by design]
* xref:ROOT:quality/pdf-compatibility.adoc#QA-060[QA-060 — PDF compatibility of generated output]
