export class MatrixGenerator {
    ...
    exportToCSV(type = 'req-impl') {
        ...
        lines.push(`Requirements with Implementation,${matrix.coverage.requirementsWithImplementation}`);
        lines.push(`Requirements with Tests,${matrix.coverage.requirementsWithTests}`);
        lines.push(`Implementation Coverage,${matrix.coverage.implementationCoverage}%`);
        lines.push(`Test Coverage,${matrix.coverage.testCoverage}%`);
        return lines.join('\n');
    }
    /**
