...
describe('Requirements Traceability', function () {
    ...
    describe('Requirement Definition', function () {
        it('should allow adding requirements with unique identifiers', function () {
            ...
            (0, chai_1.expect)(retrieved.id).to.equal('REQ-001');
            (0, chai_1.expect)(retrieved.title).to.equal('User Authentication');
            (0, chai_1.expect)(retrieved.status).to.equal('approved');
        });
        it('should store requirement content and attributes', function () {
            ...
            (0, chai_1.expect)(retrieved.content).to.equal('All sensitive data must be encrypted at rest.');
            (0, chai_1.expect)(retrieved.attributes.priority).to.equal('high');
            (0, chai_1.expect)(retrieved.attributes.category).to.equal('security');
        });
        it('should track source file and line information', function () {
            ...
            (0, chai_1.expect)(retrieved.sourceFile).to.equal('compliance.adoc');
            (0, chai_1.expect)(retrieved.sourceLine).to.equal(42);
        });
    });
    describe('Traceability Linking', function () {
        ...
        it('should establish satisfies relationships between requirements', function () {
            ...
            (0, chai_1.expect)(relationships).to.have.lengthOf(1);
            (0, chai_1.expect)(relationships[0].fromId).to.equal('REQ-101');
        ...
        it('should establish implements relationships', function () {
            ...
            (0, chai_1.expect)(relationships).to.have.lengthOf(1);
            (0, chai_1.expect)(relationships[0].fromId).to.equal('IMP-100');
            (0, chai_1.expect)(relationships[0].targetId).to.equal('REQ-100');
            (0, chai_1.expect)(relationships[0].type).to.equal('implements');
        });
        it('should establish tests relationships', function () {
            ...
            (0, chai_1.expect)(relationships).to.have.lengthOf(1);
            (0, chai_1.expect)(relationships[0].fromId).to.equal('TEST-100');
            (0, chai_1.expect)(relationships[0].targetId).to.equal('REQ-100');
            (0, chai_1.expect)(relationships[0].type).to.equal('tests');
        });
        it('should establish verifies relationships', function () {
            ...
            (0, chai_1.expect)(relationships).to.have.lengthOf(1);
            (0, chai_1.expect)(relationships[0].type).to.equal('verifies');
        });
        it('should establish documents relationships', function () {
            ...
            (0, chai_1.expect)(relationships).to.have.lengthOf(1);
            (0, chai_1.expect)(relationships[0].type).to.equal('documents');
        });
        it('should retrieve reverse relationships', function () {
            ...
            (0, chai_1.expect)(implRelationships).to.have.lengthOf(1);
            (0, chai_1.expect)(implRelationships[0].fromId).to.equal('IMP-100');
            const testRelationships = extension.graph.getReverseRelationships('REQ-100', 'tests');
            (0, chai_1.expect)(testRelationships).to.have.lengthOf(1);
            (0, chai_1.expect)(testRelationships[0].fromId).to.equal('TEST-100');
        });
    });
    describe('Matrix Generation', function () {
        ...
        it('should generate requirements-to-implementation matrix', function () {
            ...
            (0, chai_1.expect)(req200).to.not.be.undefined;
            (0, chai_1.expect)(req200.implementations).to.include('IMP-200');
            (0, chai_1.expect)(req200.tests).to.include('TEST-200');
        });
        ...
        it('should export matrix to CSV format', function () {
            ...
            (0, chai_1.expect)(csv).to.include('REQ-200');
            (0, chai_1.expect)(csv).to.include('REQ-201');
            (0, chai_1.expect)(csv).to.include('IMP-200');
        ...
        it('should include coverage information in CSV', function () {
            const csv = extension.exportMatrixToCSV('req-impl');
            (0, chai_1.expect)(csv).to.include('Requirements with Implementation');
            (0, chai_1.expect)(csv).to.include('Requirements with Tests');
        });
    });
    describe('Coverage Reporting', function () {
        ...
        it('should report coverage metrics', function () {
            ...
            (0, chai_1.expect)(coverage.implementationCoverage).to.be.a('number');
            (0, chai_1.expect)(coverage.testCoverage).to.be.a('number');
        });
        it('should identify uncovered requirements', function () {
            const uncovered = extension.getUncoveredRequirements();
            (0, chai_1.expect)(uncovered).to.have.lengthOf(1);
            (0, chai_1.expect)(uncovered[0].id).to.equal('REQ-302');
        });
        it('should identify requirements with implementations', function () {
            ...
            (0, chai_1.expect)(withImpl.size).to.equal(2);
            (0, chai_1.expect)(Array.from(withImpl)).to.include('REQ-300');
            (0, chai_1.expect)(Array.from(withImpl)).to.include('REQ-301');
        });
        it('should identify requirements with tests', function () {
            const withTests = extension.graph.getRequirementsWithTests();
            (0, chai_1.expect)(withTests.size).to.equal(1);
            (0, chai_1.expect)(Array.from(withTests)).to.include('REQ-300');
        });
    });
    describe('Error Handling', function () {
        it('should detect and prevent duplicate IDs', function () {
            ...
            (0, chai_1.expect)(() => extension.graph.addRequirement(req2))
            ...
            (0, chai_1.expect)(allReqs).to.have.lengthOf(1);
            (0, chai_1.expect)(allReqs[0].title).to.equal('First');
        });
        it('should detect missing source node in relationships', function () {
            // Try to add a relationship with non-existent source node
            (0, chai_1.expect)(() => extension.addRelationship('IMP-999', 'REQ-001', 'implements'))
        ...
        it('should detect missing target node in relationships', function () {
            ...
            (0, chai_1.expect)(() => extension.addRelationship('REQ-001', 'REQ-999', 'satisfies'))
    ...
    describe('Path Finding', function () {
        ...
        it('should find paths between nodes', function () {
            ...
            (0, chai_1.expect)(path).to.include('REQ-400');
            (0, chai_1.expect)(path).to.include('REQ-401');
        });
        ...
        it('should perform impact analysis', function () {
            ...
            (0, chai_1.expect)(impacted).to.include('REQ-401');
        });
    });
    describe('Detailed Matrix with All Entities', function () {
        ...
        it('should get requirements with details', function () {
            ...
            (0, chai_1.expect)(requirements).to.have.lengthOf(1);
            (0, chai_1.expect)(requirements[0].id).to.equal('REQ-500');
            (0, chai_1.expect)(requirements[0].implementedBy).to.include('IMP-500');
            (0, chai_1.expect)(requirements[0].testedBy).to.include('TEST-500');
            (0, chai_1.expect)(requirements[0].verifiedBy).to.include('TEST-500');
            (0, chai_1.expect)(requirements[0].documentedBy).to.include('DOC-500');
        });
        it('should get implementations with details', function () {
            const implementations = extension.getImplementationsWithDetails();
            (0, chai_1.expect)(implementations).to.have.lengthOf(1);
            (0, chai_1.expect)(implementations[0].id).to.equal('IMP-500');
            (0, chai_1.expect)(implementations[0].satisfies).to.include('REQ-500');
        });
        it('should get tests with details', function () {
            const tests = extension.getTestsWithDetails();
            (0, chai_1.expect)(tests).to.have.lengthOf(1);
            (0, chai_1.expect)(tests[0].id).to.equal('TEST-500');
            (0, chai_1.expect)(tests[0].verifies).to.include('REQ-500');
            (0, chai_1.expect)(tests[0].tests).to.include('REQ-500');
        });
    });
});
