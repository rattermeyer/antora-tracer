...
describe('Validation', function () {
    ...
    describe('Duplicate ID Detection', function () {
        ...
        it('should prevent duplicate implementation IDs', function () {
            ...
            (0, chai_1.expect)(() => extension.addImplementation({
                id: 'IMP-001',
                title: 'Second',
        ...
        it('should prevent duplicate test IDs', function () {
            ...
            (0, chai_1.expect)(() => extension.addTest({
                id: 'TEST-001',
                title: 'Second',
                content: 'Second test',
                status: 'passed',
        ...
        it('should prevent duplicate document IDs', function () {
            ...
            (0, chai_1.expect)(() => extension.addDocument({
                id: 'DOC-001',
                title: 'Second',
    ...
    describe('Relationship Validation', function () {
        ...
        it('should detect missing source node', function () {
            (0, chai_1.expect)(() => extension.addRelationship('NONEXISTENT', 'REQ-001', 'implements'))
                .to.throw('Source node not found: NONEXISTENT');
        });
        it('should detect missing target node', function () {
            (0, chai_1.expect)(() => extension.addRelationship('REQ-001', 'NONEXISTENT', 'satisfies'))
    ...
    describe('Circular Reference Detection', function () {
        it('should detect direct circular reference', function () {
            ...
            (0, chai_1.expect)(() => extension.addRelationship('REQ-002', 'REQ-001', 'depends'))
        ...
        it('should detect indirect circular reference', function () {
            ...
            (0, chai_1.expect)(() => extension.addRelationship('REQ-003', 'REQ-001', 'depends'))
                .to.throw('Circular reference detected');
        });
        it('should detect circular reference with implementation', function () {
            ...
            (0, chai_1.expect)(() => extension.addRelationship('IMP-001', 'REQ-001', 'requires'))
                .to.throw('Circular reference detected');
        });
        it('should allow non-circular dependencies', function () {
            ...
            extension.addRelationship('REQ-001', 'REQ-002', 'depends');
            // Should not throw
            (0, chai_1.expect)(() => extension.addRelationship('REQ-002', 'REQ-003', 'depends'))
    ...
    describe('Graph Validation', function () {
        it('should return empty array for valid graph', function () {
            ...
            (0, chai_1.expect)(errors).to.be.an('array');
            (0, chai_1.expect)(errors).to.have.lengthOf(0);
        });
    ...
    describe('ID Validation', function () {
        it('should validate standard ID format', function () {
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('REQ-001')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('IMP-001')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('TEST-001')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('DOC-001')).to.be.true;
        });
        it('should reject non-standard ID format', function () {
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('req-001')).to.be.false; // lowercase
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('REQ-1')).to.be.true; // single digit is valid per regex
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('REQ-ABC')).to.be.false; // letters in number
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('REQUIREMENT-001')).to.be.false; // too long prefix (>4 chars)
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidId('R-001')).to.be.false; // too short prefix (<2 chars)
        });
    });
    describe('Relationship Type Validation', function () {
        it('should validate standard relationship types', function () {
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('implements')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('satisfies')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('tests')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('verifies')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('documents')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('depends')).to.be.true;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('requires')).to.be.true;
        });
        it('should reject invalid relationship types', function () {
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('invalid')).to.be.false;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('')).to.be.false;
            (0, chai_1.expect)(index_1.RequirementsTraceabilityExtension.isValidRelationshipType('implement')).to.be.false; // singular
        });
    });
});
