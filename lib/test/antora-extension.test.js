...
[item, id=IMP-001, role=implementation, title="AuthService"]
====
...
describe('AntoraTraceabilityExtension', () => {
    ...
    describe('Content Processing', () => {
        it('should process AsciiDoc files when contentClassified fires', async () => {
            ...
            expect(req.title).to.equal('User Authentication');
...
[item, id=IMP-001, role=implementation, title="Implementation 1"]
====
Implements req 1.
...
[item, id=IMP-002, role=implementation, title="Implementation 2"]
====
Implements req 2.
