...
`;
            ...
            (0, chai_1.expect)(parsed.requirements).to.have.lengthOf(2);
            (0, chai_1.expect)(parsed.implementations).to.have.lengthOf(2);
            (0, chai_1.expect)(parsed.tests).to.have.lengthOf(2);
            (0, chai_1.expect)(parsed.documents).to.have.lengthOf(1);
            // Verify relationships were parsed
            (0, chai_1.expect)(parsed.relationships.length).to.be.at.least(6);
            ...
            (0, chai_1.expect)(allRequirements).to.have.lengthOf(2);
            const allImplementations = extension.graph.getAllImplementations();
            (0, chai_1.expect)(allImplementations).to.have.lengthOf(2);
            const allTests = extension.graph.getAllTests();
            (0, chai_1.expect)(allTests).to.have.lengthOf(2);
            const allDocuments = extension.graph.getAllDocuments();
            (0, chai_1.expect)(allDocuments).to.have.lengthOf(1);
            // Verify coverage
            ...
            (0, chai_1.expect)(coverage.requirementsWithTests).to.equal(2);
            (0, chai_1.expect)(coverage.implementationCoverage).to.equal(100);
            (0, chai_1.expect)(coverage.testCoverage).to.equal(100);
            ...
            (0, chai_1.expect)(detailedMatrix.requirements).to.have.lengthOf(2);
            (0, chai_1.expect)(detailedMatrix.implementations).to.have.lengthOf(2);
            (0, chai_1.expect)(detailedMatrix.tests).to.have.lengthOf(2);
            // Verify CSV export
...
`;
            ...
            (0, chai_1.expect)(path.length).to.equal(4);
            (0, chai_1.expect)(path).to.include('REQ-001');
            (0, chai_1.expect)(path).to.include('REQ-004');
            // Verify impact analysis (follows both directions)
            const impacted = extension.getImpactAnalysis('REQ-001');
            (0, chai_1.expect)(impacted).to.include('REQ-002');
            (0, chai_1.expect)(impacted).to.include('REQ-003');
            (0, chai_1.expect)(impacted).to.include('REQ-004');
        });
    });
...
`;
            ...
            (0, chai_1.expect)(parsed.requirements).to.have.lengthOf(1);
            (0, chai_1.expect)(parsed.implementations).to.have.lengthOf(1);
            (0, chai_1.expect)(parsed.tests).to.have.lengthOf(1);
            (0, chai_1.expect)(parsed.relationships).to.have.lengthOf(2);
        });
...
`;
            ...
            (0, chai_1.expect)(req.sourceFile).to.equal('root.adoc');
            const imp = extension.graph.getImplementation('IMP-001');
            (0, chai_1.expect)(imp).to.not.be.undefined;
            (0, chai_1.expect)(imp.sourceFile).to.equal('module/page.adoc');
            const test = extension.graph.getTest('TEST-001');
            (0, chai_1.expect)(test).to.not.be.undefined;
            (0, chai_1.expect)(test.sourceFile).to.equal('module/page/test.adoc');
            // Verify relationships work across files
            const coverage = extension.getCoverageReport();
            (0, chai_1.expect)(coverage.totalRequirements).to.equal(1);
...
`;
    ...
    describe('Performance with Different Structures', function () {
        ...
        it('should handle wide dependency graphs efficiently', function () {
            ...
            (0, chai_1.expect)(coverageTime).to.be.lessThan(100);
            (0, chai_1.expect)(coverage.totalRequirements).to.equal(51);
            ...
            (0, chai_1.expect)(impactTime).to.be.lessThan(100);
            // Should find all 50 dependencies + 50 implementations = 100
            (0, chai_1.expect)(impacted.length).to.equal(100);
        });
        it('should handle deep dependency chains efficiently', function () {
            ...
            (0, chai_1.expect)(pathTime).to.be.lessThan(100);
            (0, chai_1.expect)(path).to.not.be.null;
            (0, chai_1.expect)(path.length).to.equal(50);
        });
    });
...
`;
            ...
            // Should be identical
            (0, chai_1.expect)(matrix1.type).to.equal(matrix2.type);
            (0, chai_1.expect)(matrix1.requirements.length).to.equal(matrix2.requirements.length);
            (0, chai_1.expect)(matrix1.coverage.totalRequirements).to.equal(matrix2.coverage.totalRequirements);
            ...
            (0, chai_1.expect)(reqImplMatrix.type).to.equal('req-impl');
            (0, chai_1.expect)(reqTestMatrix.type).to.equal('req-test');
            (0, chai_1.expect)(fullMatrix.type).to.equal('full');
        });
...
`;
            ...
            (0, chai_1.expect)(csv).to.include('"Test, with comma"');
            // Should have summary
