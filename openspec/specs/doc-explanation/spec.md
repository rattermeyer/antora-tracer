...
The example site documentation follows the Diátaxis framework. The Explanation section provides understanding-oriented pages covering concepts, architecture, design rationale, and comparisons.
