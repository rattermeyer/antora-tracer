...
The example site documentation follows the Diátaxis framework. The Tutorial section provides a single guided path for first-time users to get from zero to a working traceability setup.
