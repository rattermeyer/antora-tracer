...
Per-role authoring guidance (an AsciiDoc page plus an optional idPrefix) declared in the traceability config, shipped as preset defaults, resolvable via CLI, and rendered into the consuming site.
