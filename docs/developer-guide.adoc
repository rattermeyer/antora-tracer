...
Inline macro regex: `/<relation-type>:<TARGET-ID>\[\]/` — relation types are user-defined, so the parser accepts any valid identifier before the colon.
...
describe('MyFeature', () => {
  it('should do something', () => {
    ...
    extension.process(`...[item, id=X, role=requirement]...`, { sourceFile: 'test.adoc' });
