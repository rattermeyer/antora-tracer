...
When you read a matrix, you're asking: "For each requirement, which designs address it? Which implementations satisfy it? Which tests verify it?" The answers come from the relationships defined in your items.
