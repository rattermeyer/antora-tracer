...
* link:docs/user-guide.adoc[User Guide] — Full reference: macros, relations, CLI, presets
* link:docs/developer-guide.adoc[Developer Guide] — API, architecture, contributing, testing
...
Contributions are welcome. See the link:docs/developer-guide.adoc[Developer Guide] for setup, code style, and testing.
