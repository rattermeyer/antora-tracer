...
import { DocumentParserV2, type ParserResult, type ParserWarning, type ParserError } from './DocumentParserV2.js';
import { TraceabilityGraphV2, type ValidationResult } from './TraceabilityGraphV2.js';
...
export class RequirementsTraceabilityExtensionV2 {
  public readonly graph: TraceabilityGraphV2;
  public configLoader?: ConfigLoader;
  private readonly parser: DocumentParserV2;
   ...
   */
  static async createWithConfig(configPath?: string): Promise<RequirementsTraceabilityExtensionV2> {
   ...
   */
  static async createWithPreset(presetName: BuiltInPresetName): Promise<RequirementsTraceabilityExtensionV2> {
   ...
   */
  process(content: string, options: { sourceFile?: string } = {}): ParserResult & { graph: TraceabilityGraphV2 } {
   ...
   */
  exportToNeo4jCSV(_options: Neo4jExportOptions): Neo4jExportResult {
 ...
 */
export function createExtensionV2(_configPath?: string): RequirementsTraceabilityExtensionV2 {
 ...
 */
export async function createExtensionWithPreset(presetName: BuiltInPresetName): Promise<RequirementsTraceabilityExtensionV2> {
...
// Parser types
export type { ParserWarning, ParserError, ParserOptions, ParserResult } from './DocumentParserV2.js';

// Graph types
export type { GraphWarning, ValidationResult } from './TraceabilityGraphV2.js';
...
// Core types
export type { Item, ItemRelationship } from './types-v2.js';
